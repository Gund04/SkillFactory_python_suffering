...
class PetFriends:
    ...
    def get_list_of_pets(self, auth_key, filter):
        """
        Этот метод получает список питомцев
    ...
    def add_new_pet(self, auth_key, name, animal_type, age, pet_photo):
        """
        Этот метод добавляет информацию о новом питомце.
    ...
    def delete_pet(self, auth_key, pet_id):
        """
        Этот метод удаляет информацию о питомце из базы данных.
    ...
    def update_pet(self, auth_key, pet_id, name, animal_type, age):
        """
        Этот метод обновляет информацию о питомце.
    ...
    def add_new_pet_without_photo(self, auth_key, name, animal_type, age):
        """
        Этот метод добавляет информацию о новом питомце без фото
    ...
    def set_photo_pet(self, auth_key, pet_id, pet_photo):
        """
        Этот метод добавляет фотографию питомца.
